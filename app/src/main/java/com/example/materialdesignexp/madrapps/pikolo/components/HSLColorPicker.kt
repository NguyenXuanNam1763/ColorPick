package com.example.materialdesignexp.madrapps.pikolo.components
...
import com.example.materialdesignexp.R
import com.example.materialdesignexp.madrapps.pikolo.components.hsl.HslMetrics
import com.example.materialdesignexp.madrapps.pikolo.components.hsl.HueComponent
import com.example.materialdesignexp.madrapps.pikolo.components.hsl.LightnessComponent
import com.example.materialdesignexp.madrapps.pikolo.components.hsl.SaturationComponent
...
open class HSLColorPicker @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ColorPicker(context, attrs, defStyleAttr) {
    ...
    override fun setColorBorder(color: Int) {
        ...
        hueComponent.indicatorStrokeColor = colorTamp
        saturationComponent.indicatorStrokeColor = colorTamp
        lightnessComponent.indicatorStrokeColor = colorTamp
